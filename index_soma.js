...
const pontoSE1 = document.getElementById("pontoS")
console.log("texto sobre pontos e quanto tem  " + pontoSE1.innerText)
...
pontoSE1.innerText = "ponto :" + pontoS;
console.log("para exibir quantos pontos tem  " + pontoSE1)
...
console.log("exibi a pergunta com numeros aleatorios:  " + questaoSomaE1)

//pega os números e multiplica eles, depois salva na var "correctAns"(resposta_correta)
const correctSomaAns = num1s + num2s;
console.log("soma os numeros, para corrigir  " + correctSomaAns)
...
console.log(" modifica a form, faz a comparaçao do numeros,se acertou ou nao, e salva no ponto  :" + formSomaE1.innerText)


function updateLocalStorageSoma() {
    localStorage.setItem("ponto", JSON.stringify(+pontoS))
}
console.log(updateLocalStorageSoma())


console.log("update local storage soma  :" + updateLocalStorageSoma())
